                                ...
                                <tbody className="divide-y">
                                  {Object.entries(rawObj).map(([key, val]) => (
                                    <tr key={key} className="hover:bg-muted/30">
                                      <td className="px-3 py-2 font-mono text-muted-foreground align-top break-all">
                                        {key}
                                      </td>
                      ...
                      <div className="space-y-4 overflow-y-auto max-h-[50vh]">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 p-4 bg-muted/50 rounded-lg border">
                          ...
                          {payload.due_date && (
                            <div>
                              ...
                              <p className="text-sm">
                                {format(new Date(payload.due_date), "PP")}
                              </p>
                            </div>
                          )}
                          ...
                          <div className="p-4 bg-muted/50 rounded-lg border">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              {[
                                [
                                  "Payable Amount",
                                  payload.legal_monetary_total.payable_amount,
                                ],
                                [
                                  "Tax Exclusive",
                                  payload.legal_monetary_total
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              <div>
                                ...
                                <p className="text-sm font-semibold">
                                  {formatAmount(
                                    Number(
                                      payload.tax_total[0].tax_amount ?? 0,
                                    ),
                                    currency,
                                  )}
                                </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {payload.accounting_supplier_party && (
                            <div className="p-4 border rounded-lg space-y-2">
                              ...
                              <p className="text-sm font-medium">
                                {payload.accounting_supplier_party.party_name}
                              </p>
                              {payload.accounting_supplier_party.tin && (
                                <p className="text-xs text-muted-foreground">
                                  TIN:{" "}
                              ...
                              {payload.accounting_supplier_party.email && (
                                <p className="text-xs text-muted-foreground">
                                  Email:{" "}
                                  {payload.accounting_supplier_party.email}
                                </p>
                              )}
                              {payload.accounting_supplier_party.telephone && (
                                <p className="text-xs text-muted-foreground">
                                  Phone:{" "}
                                  {payload.accounting_supplier_party.telephone}
                                </p>
                          ...
                          {payload.accounting_customer_party && (
                            <div className="p-4 border rounded-lg space-y-2">
                              ...
                              {payload.accounting_customer_party.tin && (
                                <p className="text-xs text-muted-foreground">
                                  TIN:{" "}
                                  <span className="font-mono text-foreground">
                                    {payload.accounting_customer_party.tin}
                              ...
                              {payload.accounting_customer_party.email && (
                                <p className="text-xs text-muted-foreground">
                                  Email:{" "}
                                  {payload.accounting_customer_party.email}
                                </p>
                              )}
                              {payload.accounting_customer_party.telephone && (
                                <p className="text-xs text-muted-foreground">
                                  Phone:{" "}
                                  {payload.accounting_customer_party.telephone}
                                </p>
                        ...
                        {payload.invoice_line?.length > 0 && (
                          <div className="border rounded-lg overflow-hidden">
                            <p className="text-xs font-medium text-muted-foreground px-4 py-2 bg-muted/50 border-b">
                              Line Items
                            </p>
                            <div className="divide-y">
                              {payload.invoice_line.map(
                                (line: any, idx: number) => (
                                  <div
                                    key={idx}
                                    className="px-4 py-3 grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs"
                                  >
                                    <div>
                                      <p className="text-muted-foreground">
                                        Item
                                    ...
                                    <div>
                                      ...
                                      <p className="font-medium">
                                        {formatAmount(
                                          Number(line.price?.price_amount || 0),
                                          currency,
                                        )}
                                      </p>
                                    </div>
